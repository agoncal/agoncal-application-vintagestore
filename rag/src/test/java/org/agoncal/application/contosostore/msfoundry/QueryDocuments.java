...
//    embedAndSearch();
  ...
  private static void chat(ChatModel chatModel) {
    ...
    String answer = chatModel.chat("What is the VAT number of Contoso Store?");
    System.out.println("Chat Model \n" + answer + "\n");
  }

  private static void embedAndSearch() {
    // Question to ask
    Embedding embeddedQuestion = embeddingModel.embed("What is the VAT number of Contoso Store?").content();

...
10. [CONTRIBUTION LICENCE](#10-contribution-licence)
11. [GUIDELINES FOR REVIEWS](#11-guidelines-for-reviews)
12. [MOBILE APPLICATION LICENCE](#12-mobile-application-licence)
...
- **E-commerce marketplace** for vintage collectibles, vinyl records, CDs, cassette tapes, and books
- **Product authentication and verification** services for rare and valuable items
- **User account management** including order history, wish lists, and personalized recommendations
- **Customer support** including live chat, email support, and phone assistance
- **Mobile application** for iOS and Android devices with full shopping functionality
- **Community features** including product reviews, ratings, and collector forums
...
**Account Security:** You are responsible for safeguarding the password and for all activities that occur under your account. You agree to immediately notify us of any unauthorised use of your account or any other breach of security.

**Account Information:** You agree to provide accurate, current, and complete information during registration and to update such information as necessary to keep it accurate, current, and complete.
...
**Vintage Item Considerations:**
- All vintage items are sold in their current condition and may show signs of wear, aging, or minor defects consistent with their age
- Product descriptions include condition assessments, but buyers should expect normal vintage wear
- Rare items may have minor imperfections that do not significantly impact their value or functionality
- All vinyl records, CDs, and tapes are tested for playability before listing, but vintage audio quality may vary
...
- You will receive email confirmation when your order is placed and when it ships
- Tracking information will be provided for all shipments

## 7. RETURN POLICY

Please review our Return Policy posted on the Services prior to making any purchases. Our return policy includes:
...
- **Create fake product reviews or manipulate our rating system**.
- **Resell items purchased from our Services without proper authorisation**.
- **Attempt to circumvent payment processing or commit payment fraud**.
...
**Additional Guidelines for Vintage Item Reviews:**
- Focus on item condition, authenticity, and seller accuracy
- Include relevant details about packaging, shipping speed, and customer service
- Be honest about any discrepancies between item description and actual condition
- Avoid reviews based solely on personal taste preferences for vintage items
...
- All advertisements are clearly marked as such
- We do not endorse any advertised products or services
- Third-party advertisers are responsible for their own content and claims
- Users should exercise caution when interacting with advertisements
...
To expedite resolution and reduce the cost of any dispute, controversy, or claim related to these Legal Terms ('Dispute'), you and we agree to first attempt to negotiate any Dispute informally for at least **30 days** before initiating any arbitration or court proceeding. Such informal negotiations commence upon written notice from one person to the other person.

**Binding Arbitration**

Any dispute arising out of or in connection with these Legal Terms, including any question regarding their existence, validity, or termination, shall be referred to and finally resolved by the American Arbitration Association ('AAA') under its Consumer Arbitration Rules. The arbitration shall take place in **California, United States**, in the English language, and the arbitral decision may be enforced in any court.

**Exceptions to Arbitration**

The following Disputes are not subject to the above provisions concerning binding arbitration: (a) any Disputes seeking to enforce or protect, or concerning the validity of, any of our intellectual property rights; (b) any Dispute related to, or arising from, allegations of theft, piracy, invasion of privacy, or unauthorized use; and (c) any claim for injunctive relief.

If this provision is found to be illegal or unenforceable, then neither you nor we will elect to arbitrate any Dispute falling within that portion of this provision found to be illegal or unenforceable and such Dispute shall be decided by a court of competent jurisdiction within the courts listed for jurisdiction above, and you and we each waive any right to a jury trial concerning such Disputes.

...
public class LegalDocumentTools {
  ...
  private static final Logger LOG = Logger.getLogger(LegalDocumentTools.class);
  ...
  LocalDate lastUpdateAcceptableUsePolicy() {
    LOG.debug("lastUpdateAcceptableUsePolicy()");
  ...
  LocalDate lastUpdateDisclaimer() {
    LOG.debug("lastUpdateDisclaimer()");
  ...
  LocalDate lastUpdateEndOfUserLicenseAgreement() {
    LOG.debug("lastUpdateEndOfUserLicenseAgreement()");

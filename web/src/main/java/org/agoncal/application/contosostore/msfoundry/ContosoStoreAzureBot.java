package org.agoncal.application.contosostore.msfoundry;

import org.jboss.logging.Logger;

import static java.time.Duration.ofSeconds;

public class ContosoStoreAzureBot {

  private static final Logger LOG = Logger.getLogger(ContosoStoreAzureBot.class);
...
//  private static final String CHAT_MODEL = "contosostore-chat-model";
//  private static final String MODERATION_MODEL = "contosostore-moderation-model";
//  private static final String EMBEDDING_MODEL = "contosostore-embedding-model";
//  private static final String SUMMARIZATION_MODEL = "contosostore-summarization-model";
...
//  private static final String AZURE_SEARCH_COLLECTION = "ContosoStore";
...
//      .build();
//
//    // Create the ContosoStoreAssistant with all components

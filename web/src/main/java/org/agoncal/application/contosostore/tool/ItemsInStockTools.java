package org.agoncal.application.contosostore.tool;
...
import org.agoncal.application.contosostore.model.Item;
...
public class ItemsInStockTools {
  ...
  @Tool(name = "get_top_rated_items", value = "Retrieves all items with the highest rating (5 stars) from the Contoso Store catalog. Use this when customers ask for bestsellers, highest-rated, or premium recommendations.")
  ...
  @Tool(name = "search_catalog", value = "Searches the entire Contoso Store catalog by keyword, looking through titles, descriptions, and metadata. Use this for broad searches when customers describe what they're looking for rather than specific titles.")
